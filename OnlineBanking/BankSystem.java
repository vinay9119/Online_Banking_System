...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem () {
		...
		author = new JLabel (" " + "Online BankSystem Pvt Ltd.", Label.LEFT);
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			String msg = "Online BankSystem Pvt Ltd.\n\n" + "Created & Designed By:\n" + 
				"Umashankar Dalai\n\n" + "E-mail me:\n umashankardalai2003@gmail.com";
	...
	private void quitApp () {
		...
		try {
			...
			if (reply == JOptionPane.YES_OPTION) {
				...
				System.out.println ("Thanks for Using Online BankSystem\nCreator - Umashankar Dalai");
	...
	String makeRecordPrint (int rec) {
		...
		String data;
		String data0 = "              Online BankSystem Pvt Ltd.               \n";	//Page Title.
		...
		String data6 = "          Copyright � 2023 Umashankar Dalai.\n";	//Page Footer.
		String sep0 = " -----------------------------------------------------------\n";
		String sep1 = " -----------------------------------------------------------\n";
		String sep2 = " -----------------------------------------------------------\n";
		String sep3 = " -----------------------------------------------------------\n";
